                    ...
                    <div class="list-contant">
                        <div class="box-one">
                            <div class="box-one-contant">
                                ...
                                <ul class="nav-tabs">
                                      ...
                                      <li class="pull-right"><a data-toggle="tab" href="#owner">{{trans('countries::home/home.owner_name')}}</a></li>
                                </ul>
                        ...
                        <div class="box-four">
                            ...
                            <div class="locate-box">
                                <div class="popup-tab">
                                        <ul class="nav-tabs">
                                            @foreach($neighbourhoods as $key=>$neighbourhood)
                                               ...
                                               $neighbourhood_id = $neighbourhood->id;
                                                @endphp
                                                @foreach($selectedneigh as $selected)
                                                ...
                                                @if($show_neigh->id ==$neighbourhood_id || $show_neigh->parent_id == $neighbourhood_id )

                                                <li class="@if($Ncount == 1) active @endif"><a data-toggle="tab" href="#menu{{$show_neigh->name}}" onclick="showNeighbourhoodMap('{{$show_neigh->id}}',{{$selected['kilometer']}})">{{$neighbourhood->name}}</a></li>
                                                @endif
                                                @endforeach
                                                @php $Ncount++; @endphp
                                                @endforeach
                                        ...
                                        <div class="tab-content">
                                           ...
                                           $neighbourhood_id = $neighbourhood->id;
                                            @endphp
                                            @foreach($selectedneigh as $selected)  @php
                                                $show_neigh = Modules\Properties\Entities\Neighbourhood::find($selected['neighbourhood_id']);
                                             ...
                                             <div id="menu{{$show_neigh->name}}" class="tab-pane fade @if($Ncount == 1) in active @endif">
                                                <div id="gmap_canvas_{{$show_neigh->id}}" class="gmap_canvas"></div>
                                                <form class="options1">
                                                    <label for="radiusInput">{{trans('countries::home/home.Radius')}} : {{$selected['kilometer']}} {{trans('countries::home/home.meter_r')}}</label>
                                                </form>
                            ...
                            <?php
                                ...
                                $title= urlencode(@$property_details['title'])." Price:".$currency_symbol.urlencode(money_format_pro_de($property_lists->prize) );
                              //  $url=urlencode($url);
                                    ...
                                    <div class="profile-tab-box featured_properties featured_properties_slick">
                                        <div class="tab-content">
                                            <div role="tabpanel" class="tab-pane active row popup-slide-1" id="popup-slide-1">
                                                ...
                                                <?php } else { ?>
                                                     <span>{{@$currency_symbol}}</span>
                                                <?php } ?> {{  money_format_pro_de($property_lists->prize) }}/- <small><?php echo (in_array('3',$selectedPropertyTypeId) || in_array('4',$selectedPropertyTypeId))?trans('countries::home/home.featured_per_month'):''; ?></small></h5>
...
function initializeMap() {
    ...
    map = new google.maps.Map(document.getElementById('gmap_canvas_{{$sn["neighbourhood_id"]}}'), myOptions);
