                                    ...
                                    <div class="popup-tab">
                                        <ul class="nav-tabs">
                                             ...
                                             @foreach($selectedneigh as $key=>$neighbourhood)
                                                ...
                                                $show_neigh = Modules\Properties\Entities\Neighbourhood::find($neighbourhood['neighbourhood_id']);
...
function createMarker(obj) {
    ...
    <?php if(count($selectedneigh) > 0 ){  $sn =$selectedneigh[0]; 
        ...
        if($show_neigh->language_id !== $Selected_lang)
                                                ...
                                                {
                                                    $show_neigh_data = Modules\Properties\Entities\Neighbourhood::where("id",$sn['neighbourhood_id'])->first();
                                                }
    ?>
